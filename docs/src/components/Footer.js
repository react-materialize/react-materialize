...
const PageFooter = () => {
  ...
  const moreLinks = <a href='https://github.com/react-materialize/react-materialize/blob/master/LICENSE'>Code licensed under MIT</a>;

  return (
    <Footer links={links} copyrights='© 2018 React Materialize, All rights reserved ' moreLinks={moreLinks}>
